...
public class Main {
    ...
    static boolean only2digit=false;
...
//                System.out.println(matcher.groupCount()+"inputs="+inputs);
...
//                        System.out.print(matcher.start(1) + "g1=" + si + ": ");
...
//                        System.out.print(",,"+matcher.start(2)+"g2="+matcher.group(2));
...
//                        System.out.println("," + matcher.start(3) + "g3=" + sz + ".");
